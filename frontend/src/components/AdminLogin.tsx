  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#112a1d] p-4 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md p-10 rounded-[2.5rem] border border-white/10 bg-white/[0.03] backdrop-blur-md shadow-2xl relative z-10 text-left">
        ...
        {/* Title */}
        <h2 className="text-4xl font-bold text-white font-serif mb-2 tracking-wide">Sign In</h2>
        <p className="text-sm text-gray-400 mb-8">Enter admin credentials to authorize terminal.</p>
        ...
        <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
          ...
          <button 
            type="submit" 
            className="w-full py-4 mt-2 rounded-xl bg-gradient-to-r from-yellow-700/80 to-yellow-800/80 hover:from-yellow-600 hover:to-yellow-700 text-white font-medium text-center shadow-lg border border-yellow-500/10 transition active:scale-[0.99]"
          >
            Sign In
          </button>
        </form>
